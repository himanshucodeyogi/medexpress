import { User, Phone, Mail, Shield, Camera, RotateCcw, CheckCircle2, Car, Edit3, Save, Info } from 'lucide-react';
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-4 w-full sm:w-auto">
            <Link to="/delivery" className="p-2 hover:bg-slate-100 rounded-full transition-colors shrink-0">
              <RotateCcw className="w-5 h-5 text-slate-400" />
            </Link>
            <div className="min-w-0">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest truncate">Delivery Partner Profile</p>
              <h1 className="text-xl font-black text-slate-900 truncate">Marcus Chen</h1>
            </div>
            <div className="hidden xs:flex ml-2 px-2 py-0.5 bg-blue-50 text-blue-600 rounded-full text-[10px] font-bold uppercase tracking-wider items-center gap-1 shrink-0">
              <CheckCircle2 className="w-3 h-3" /> Verified
            </div>
          </div>
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button className="flex-1 sm:flex-none btn btn-primary px-6 py-2.5 text-sm font-bold flex items-center justify-center gap-2">

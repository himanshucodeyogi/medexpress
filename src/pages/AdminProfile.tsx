        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <div className="min-w-0">
              ...
              <h1 className="text-xl font-black text-slate-900 truncate">Admin Profile</h1>
            </div>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Link to="/pharmacy/1" className="flex-1 md:flex-none btn bg-white border border-slate-200 text-slate-600 px-4 py-2.5 text-sm font-bold flex items-center justify-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl text-center shadow-sm relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-20 md:h-24 bg-gradient-to-br from-primary/10 to-blue-500/10"></div>
              <div className="relative z-10">
                ...
                <h2 className="text-lg md:text-xl font-black text-slate-900">Marcus Wright</h2>
                ...
                <div className="space-y-3 mt-6 md:mt-8">
                  <div className="p-3 bg-slate-50 rounded-xl flex items-center gap-3 text-left">
                    ...
                    <span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest truncate">Licensed Pharmacist #9921</span>
                  </div>
                  <div className="p-3 bg-slate-50 rounded-xl flex items-center gap-3 text-left">
                    <Store className="w-4 h-4 text-blue-500 shrink-0" />
                    <span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest truncate">Downtown Hub Branch</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="card p-4 md:p-6 bg-white border border-slate-200 rounded-2xl flex items-center justify-between shadow-sm">
              <div className="flex items-center gap-3">
                <ShieldCheck className="w-5 h-5 text-emerald-500 shrink-0" />
                <div className="min-w-0">
                  <p className="text-xs font-black text-slate-900">Account Verified</p>
                  <p className="text-[10px] text-slate-400 font-medium leading-tight">Your identity and pharmacy credentials have been validated.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Main Content Form */}
          <form className="lg:col-span-3 space-y-6 md:space-y-8" onSubmit={(e) => e.preventDefault()}>
            {/* Basic Information */}
            ...
            <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl shadow-sm">
              <div className="flex items-center gap-4 mb-6 md:mb-8">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-emerald-50 rounded-2xl flex items-center justify-center shrink-0">
                  <Store className="w-5 h-5 md:w-6 md:h-6 text-emerald-500" />
                </div>
                <div>
                  <h3 className="text-lg md:text-xl font-black text-slate-900">Store & Logistics Info</h3>
            ...
            <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl shadow-sm">
              <div className="flex items-center gap-4 mb-6 md:mb-8">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-black text-slate-900">Security & Password</h3>
              ...
              <div className="grid grid-cols-1 gap-4 md:gap-6 max-w-2xl">
                <div className="space-y-2">
            ...
            <div className="card p-4 bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 sticky bottom-4 md:bottom-8 shadow-2xl shadow-slate-200/50 z-20">
              <p className="text-xs font-bold text-amber-600 flex items-center gap-2 px-2 md:px-4">
                <Info className="w-4 h-4 shrink-0" /> <span className="hidden xs:inline">You have unsaved changes in Store Info</span><span className="xs:hidden">Unsaved changes.</span>
              </p>
              <div className="flex gap-3 w-full sm:w-auto">
                <button type="button" className="flex-1 sm:flex-none btn bg-white border border-slate-200 text-slate-600 px-4 md:px-6 py-3 text-sm font-bold flex items-center justify-center gap-2 hover:bg-slate-50">

        ...
        <div className="p-6 md:p-12 lg:p-16 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            <div className="mb-8 md:mb-10 text-center lg:text-left">
              ...
              <div className="flex p-1 bg-slate-100 rounded-2xl mb-4 md:mb-6">
                <button 
                  className="flex-1 py-3 text-sm font-bold rounded-xl transition-all bg-white text-primary shadow-sm"
                >
                  Customer
                </button>
                <Link 
              ...
              <div className="flex p-1 bg-slate-100 rounded-2xl mb-6 md:mb-8">
                <button 
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button type="submit" className="btn btn-primary w-full py-4 text-base md:text-lg group shadow-xl shadow-primary/20">

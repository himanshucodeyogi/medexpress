        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl text-center shadow-sm relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-20 md:h-24 bg-gradient-to-br from-emerald-500/10 to-teal-500/10"></div>
              <div className="relative z-10">
                ...
                <h2 className="text-lg md:text-xl font-black text-slate-900">City Wellness Pharmacy</h2>
          ...
          {/* Main Content Form */}
          <div className="lg:col-span-3 space-y-6 md:y-8">
            {activeTab === 'store' && (
              <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl shadow-sm">
                <div className="flex items-center gap-4 mb-6 md:mb-8">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-black text-slate-900">Store Information</h3>
              ...
              <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl shadow-sm">
                <div className="flex items-center gap-4 mb-6 md:mb-8">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-indigo-50 rounded-2xl flex items-center justify-center shrink-0">
                    <User className="w-5 h-5 md:w-6 md:h-6 text-indigo-500" />
                  </div>
                  <div>
                    <h3 className="text-lg md:text-xl font-black text-slate-900">Owner Details</h3>
            ...
            {activeTab === 'license' && (
              <div className="card p-6 md:p-8 bg-white border border-slate-200 rounded-3xl shadow-sm">
                <div className="flex items-center gap-4 mb-6 md:mb-8">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-black text-slate-900">License & Compliance</h3>
            ...
            <div className="card p-4 bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 sticky bottom-4 md:bottom-8 shadow-2xl shadow-slate-200/50 z-20">
              <p className="text-xs font-bold text-slate-500 flex items-center gap-2 px-2 md:px-4">
                <Info className="w-4 h-4 shrink-0" /> <span className="hidden xs:inline">Ensure all details match official records.</span><span className="xs:hidden">Match official records.</span>
              </p>
              <div className="flex gap-3 w-full sm:w-auto">
                <button className="flex-1 sm:flex-none btn bg-white border border-slate-200 text-slate-600 px-4 md:px-6 py-3 text-sm font-bold flex items-center justify-center gap-2 hover:bg-slate-50">
                  <RotateCcw className="w-4 h-4" /> Reset
                </button>
                <button className="btn btn-primary flex-[2] sm:flex-none px-6 md:px-10 py-3 text-sm font-bold flex items-center justify-center gap-2 shadow-lg shadow-primary/20">

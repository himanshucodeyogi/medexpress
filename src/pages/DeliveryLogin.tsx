            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input type="tel" placeholder="+1 (555) 000-0000" className="input pl-12 bg-slate-50 border-slate-100" />
                    </div>
                  </div>
                </>
              )}
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  {isLogin && (
                    <button className="text-xs font-bold text-emerald-600 hover:underline">Forgot Password?</button>
                  )}
                </div>
                <div className="relative">
              ...
              <Link to="/delivery" className="btn bg-emerald-600 hover:bg-emerald-700 text-white w-full py-4 text-lg group">
